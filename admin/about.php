...
// $Id: about.php,v 1.3 2007/04/27 18:59:19 andrew Exp $
//  ------------------------------------------------------------------------ //
//  Author: Andrew Mills                                                     //
...
if (!isset($_REQUEST['op'])) {
    ...
    amcontact_adminmenu(100000, _AM_AMCONT_ABOUT); ?>
    ...
    <table border="0" cellspacing="1" style="width: 100%;" class="outer">
        ...
        <tr>
            <td class="odd">
                AM Contact is a visitor contact module for XOOPS v2, with optional image
                and
                Question &amp; Answer verification to help prevent spam messages submitted
                by bots.
            </td>
        </tr>
    </table>
    ...
    <table border="0" cellspacing="1" style="width: 100%" class="outer">
        ...
        <tr>
            ...
            <td class="odd"> version in XOOPS: <?php echo round($xoopsModule->getVar('version') / 100, 2); ?>, actual version: <?php echo _AM_AMCONTVERSION; ?>.</td>
        </tr>
        <!-- <tr>
        ...
        <tr>
            ...
            <td class="odd">
                <a href="javascript:;" onclick="javascript:window.open('<?php echo $_SERVER['PHP_SELF']; ?>?op=updates', 'preview', 'height=450,width=650,status=yes,toolbar=no,menubar=no,location=no,scrollbars=yes');">Check for updates</a>
            </td>
        </tr>
        <tr>
    </table>
    ...
    <table border="0" cellspacing="1" style="width: 100%;" class="outer">
        ...
        <tr>
            ...
            <td class="odd">
                ...
                <a href="http://support.sirium.net/modules/newbb/index.php?cat=7" target="_blank">support forums</a>
...
if (isset($_REQUEST['op']) and 'updates' == $_REQUEST['op']) {
    if (!@include('http://support.sirium.net/files/xoopsamcontact/version.txt')) {
    ...
    */ ?>
    ...
    if (_AM_AMCONTVERSION == $version) {
        ...
        <tr>
            ...
            <td>
                Your version: <?php echo _AM_AMCONTVERSION; ?><br>
